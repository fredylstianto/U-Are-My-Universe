...
const CONFIG = {
  ...
  passcode: {
    enabled: true,
    code: '2512', // 4-digit secret code (ganti dengan kode pilihanmu, misal: '1234')
    title: 'Enter Your Secret Code',
    subtitle: "Something's been waiting right past the surface, just for you.",
    eyebrow: 'FOR YOUR EYES ONLY,\nLITERALLY',
    buttonText: 'Unlock it →',
    hint: 'Your Birthday :)',
  },
};
